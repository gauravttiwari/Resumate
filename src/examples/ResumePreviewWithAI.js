        ...
        <div class="resume-preview ${selectedTemplate.id}">
          <header class="resume-header">
            ...
            <div class="contact-info">
              <p>${resumeData.email || 'email@example.com'} | ${
            ...
            ${
              (resumeData.experience || []).length > 0
                ...
                <div class="experience-item">
                  <h3>${exp.title || 'Job Title'} at ${
                        exp.company || 'Company Name'
                      }</h3>
                  <p class="date-range">${exp.startDate || 'Start Date'} - ${
            ...
            ${
              (resumeData.education || []).length > 0
                ...
                <div class="education-item">
                  <h3>${edu.degree || 'Degree'} - ${
                        edu.institution || 'Institution'
                      }</h3>
                  <p class="date-range">${edu.startYear || 'Start Year'} - ${
