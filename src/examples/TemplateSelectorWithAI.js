  ...
  useEffect(() => {
    ...
    const availableTemplates = [
      {
        ...
        type: 'tech',
        description:
          'Clean, professional template with modern design elements. Ideal for tech roles.',
      ...
      },
      {
        ...
        type: 'tech',
        description:
          'Traditional layout with minimal design. Perfect for conservative industries.',
      ...
      },
      {
        ...
        type: 'non-tech',
        description:
          'Bold, creative design with a colorful sidebar. Great for creative fields.',
      ...
      },
      {
        ...
        type: 'medical',
        description:
          'Structured template optimized for medical professionals with credential highlights.',
      ...
      },
      {
        ...
        type: 'diploma',
        description:
          'Academic-focused design highlighting education and publications.',
    ...
    if (jobType) {
      setFilteredTemplates(
        availableTemplates.filter((template) => template.type === jobType)
      );
    } else {
        ...
        <div className="template-selection-container">
          ...
          <div className="templates-grid">
            <h2>
              Available Templates{' '}
              {jobType
                ? `for ${jobType.charAt(0).toUpperCase() + jobType.slice(1)}`
                : ''}
            </h2>
                ...
                >
                  <div className="template-image">
                    <img
                      src={
                        template.imageUrl ||
                        'https://via.placeholder.com/150x200?text=Template'
                      }
                      alt={template.name}
                    />
                  </div>
