...
const TemplateRecommender = ({
  ...
  const handleGetRecommendation = async () => {
    try {
      ...
      const templateRecommendation = await recommendTemplate(
        resumeData,
        jobType
      );
      ...
      <div className="template-recommender loading">
        ...
        <div className="recommender-body">
          <div className="loading-indicator">
            ...
            <p>
              Our AI is analyzing your profile to recommend the best template.
  ...
  if (!recommendation) {
    return (
      <div className="template-recommender">
        ...
        <div className="recommender-body">
          <p>
            Let our AI recommend the best template for your {jobType} resume.
          </p>
          <button
      ...
      <div className="recommender-body">
        <div className="primary-recommendation">
          ...
          <button
            ...
            onClick={() =>
              handleSelectTemplate(recommendation.recommendedTemplate)
            }
          >
            Use This Template
          </button>
