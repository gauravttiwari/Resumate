...
const ResumeOptimizer = ({
  ...
  const handleApply = () => {
    ...
    const appliedSuggestions = {
      keywords: suggestions.suggestedKeywords.filter(
        (keyword) => selectedSuggestions[`keyword_${keyword}`]
      ),
      ...
      skills: suggestions.skillsToAdd.filter(
        (skill) => selectedSuggestions[`skill_${skill}`]
      ),
    };
      ...
      <div className="resume-optimizer loading">
        ...
        <div className="optimizer-body">
          <div className="loading-indicator">
            ...
            <p>
              Our AI is analyzing your resume and generating optimization
  ...
  if (!suggestions) {
    return (
      <div className="resume-optimizer">
        ...
        <div className="optimizer-body">
          <p>
            Let our AI analyze your resume and suggest improvements to make it
            more effective and ATS-friendly for your target job.
          </p>
        ...
        <div className="optimization-score">
          ...
          <div className="score-indicator">
            <div
              ...
              style={{
                color:
                  suggestions.optimizationScore >= 80
                    ? '#4CAF50'
                    : suggestions.optimizationScore >= 60
                    ? '#FF9800'
                    : '#F44336',
              }}
            >
      ...
      <div className="optimizer-body">
        <div className="suggestion-section">
          ...
          <p className="section-description">
            Adding these keywords can improve your resume's visibility in ATS
            systems.
          </p>
        ...
        <div className="suggestion-section">
          ...
          <p className="section-description">
            These suggestions can improve how your resume content is presented.
          </p>
          <div className="suggestions-list">
            {Object.entries(suggestions.contentSuggestions).map(
              ([field, suggestion]) => (
                <div
                  className="suggestion-item content-suggestion"
                  key={`content_${field}`}
                >
                  <label className="checkbox-label">
                    <input
        ...
        <div className="suggestion-section">
          ...
          <p className="section-description">
            These skills are relevant for your target position and should be
            highlighted.
          </p>
